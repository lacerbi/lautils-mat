function [secs, keyCode, deltaSecs] = KbWait(deviceNumber, forWhat, yeldInterval)
% [secs, keyCode, deltaSecs] = KbWait([deviceNumber][, forWhat=0, yeldInterval=0.005])
%
...
% (ie. no change in keyboard state) it will wait for yeldInterval msecs 
% before the next check. This is done to reduce the load on your system, 
% and it is important to do so. However if you want to measure reaction 
% times this is clearly not what you want, as it adds up to 5 msecs extra 
% uncertainty to all measurements!
%
